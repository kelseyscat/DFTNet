...
parser.add_argument('--batch_size', type=int, default=8,  # 大部分用了8
...
# 获取对输入数据进行预处理时的一些参数
parser.add_argument('--data_dir', type=Path,  default=r'CIA_NEW',  # CIA_NEW, LGC
                    help='the training data directory')
parser.add_argument('--image_size', type=int, nargs='+', default=[1792, 1280],  # CIA是[1792, 1280], LGC是[2560, 3072]
...
parser.add_argument('--patch_size', type=int, nargs='+', default=[256 * 4, 256 * 3],  # CIA是[256 * 4, 256 * 3], LGC是[256 * 4, 256 * 5]
